// data/tests.js - Структура з багатьма тестами
export const allTests = [
  {
    id: 'nmt-full-1',
    title: 'Комплексна підготовка: Всі теми',
    description: 'Великий тест, що охоплює основні періоди історії України: від Козаччини до Незалежності.',
    questions: [
      {
        id: 1,
        type: 'single',
      ...
      },
      {
        ...
        correct: 2,
        explanation: 'Відповідь: Пам\'ятник засновникам Києва (пам\'ятний знак 1982 року). Інші пам\'ятники належать до періоду Російської імперії.'
      },
      {
        id: 6,
        type: 'single',
  ...
  {
    id: 'history-quick-1',
    title: 'Історія України: Бліц-тест',
    description: 'Швидка перевірка знань про княжі часи та початки українського державотворення.',
    questions: [
      {
        id: 1,
        type: 'single',
        question: 'У якому році відбулося об\'єднання північних та південних руських земель князем Олегом?',
        options: ['860', '882', '911', '945'],
        correct: 1,
        explanation: 'Відповідь: 882 рік. Олег захопив Київ і проголосив його «матір’ю міст руських».'
      },
      {
        id: 2,
        type: 'single',
        question: 'Хто з київських князів запровадив християнство як державну релігію?',
        options: ['Ігор', 'Святослав', 'Володимир Великий', 'Ярослав Мудрий'],
        correct: 2,
        explanation: 'Відповідь: Володимир Великий у 988 році.'
      },
      {
        id: 3,
        type: 'single',
        question: 'Перша друкована газета в Україні «Gazette de Leopol» виходила у:',
        options: ['Києві', 'Львові', 'Харкові', 'Чернігові'],
        correct: 1,
        explanation: 'Відповідь: У Львові в 1776 році.'
      },
      {
        id: 4,
        type: 'single',
        question: 'Яку битву історики називають «битвою народів» Середньовіччя (1410 р.)?',
        options: ['Синьоводська битва', 'Битва на Ворсклі', 'Грюнвальдська битва', 'Битва під Оршею'],
        correct: 2,
        explanation: 'Відповідь: Грюнвальдська битва. У складі союзних військ були і руські хоругви.'
      },
      {
        id: 5,
        type: 'single',
        question: 'Перша конституція Пилипа Орлика була ухвалена в:',
        options: ['1648 р.', '1709 р.', '1710 р.', '1722 р.'],
        correct: 2,
        explanation: 'Відповідь: 1710 рік, місто Бендери.'
      }
    ]
  }
];
