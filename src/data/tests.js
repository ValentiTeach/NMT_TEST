...
// Основний масив із усіма тестами
export const allTests = [
  {
    id: 'nmt-full',
    title: 'Комплексна підготовка до НМТ (Всі теми)',
    ...
    questions: [
      ...
      },
      {
        ...
        correct: 2,
        // ТУТ БУЛА ПОМИЛКА. Виправлено використанням зворотних лапок ` або екрануванням.
  ...
  {
    id: 'history-brief',
    title: 'Бліц: Історія України (Тест-драйв)',
    description: '5 швидких питань для розминки перед серйозним іспитом.',
    questions: [
      {
        id: 1,
        type: 'single',
        question: 'У якому році відбулося Хрещення Русі?',
        options: ['882', '988', '1015', '1113'],
        correct: 1,
        explanation: 'Князь Володимир охрестив Русь у 988 році.'
      },
      {
        id: 2,
        type: 'single',
        question: 'Хто є автором першої української Конституції 1710 року?',
        options: ['Іван Мазепа', 'Богдан Хмельницький', 'Пилип Орлик', 'Павло Скоропадський'],
        correct: 2,
        explanation: 'Конституцію "Пакти і Конституція прав і вольностей Війська Запорозького" уклав Пилип Орлик.'
      }
      // Тут можна додати ще 3 питання
    ]
  }
];
